...
Support the project: `https://YOUR-PATREON-OR-KOFI-LINK`

## What It Offers

- Regional price comparison for GOG deals
- Fast quick view to inspect a game before opening the store page
- Curated surfaces like `Recommended`, `New Releases`, and `Good Old Games`
- A cleaner catalog flow focused on useful discovery
- Better visual prioritization for discounts, value, and buying decisions
...
- Open quick view modals
- Compare visible regional pricing
- Follow curated recommendation layers
...
- Premium recommendation layers
- Expanded collector-focused filters

See the public roadmap in [docs/roadmap.md](docs/roadmap.md).
...
- Offers page on desktop
- Offers page on mobile
- Recommended page
- Good Old Games page
...
This is an independent fan project and is not affiliated with or endorsed by GOG.
